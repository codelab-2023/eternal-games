...
import { FaBars, FaFantasyFlightGames, FaRegHeart, FaTags } from 'react-icons/fa6';
  ...
  return (
    <>
      <div className='flex items-center top-0 left-0 right-0 px-6 py-4 bg-slate-900/90 z-50 backdrop-blur-sm relative'>
        <div className={`bg-slate-900/90 px-4 text-white h-screen absolute left-0 top-[76px] overflow-y-scroll transition-transform transform ${openSideBar ? 'translate-x-0' : '-translate-x-full'}`}>
