        ...
        <div className="container mx-auto">
          <div className="flex flex-wrap items-center">
            <div className="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-deepPrimary">
...
// https://media.istockphoto.com/id/1403098902/photo/old-fashioned-gamepads.jpg?s=612x612&w=0&k=20&c=2zuMqFfFZKN1wM9_K-_sIfD7Lq-1IpvGWfUJYFfNixg=