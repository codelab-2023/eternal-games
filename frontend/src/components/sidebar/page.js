...
const SideBar = ({ isOpen, onClose }) => {
  ...
  return (
    <aside className={`sidebar bg-slate-900/90 px-4 text-white w-max absolute xs:top-19 nm:top-18 overflow-auto pb-24 transition-transform transform ${isOpen ? 'translate-x-0 ' : '-translate-x-full'}`}>
