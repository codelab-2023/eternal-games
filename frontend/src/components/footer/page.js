  ...
  return (
      <>
        <div className="px-8 sticky top-full py-4 bg-slate-900 shadow-inner shadow-slate-800 rounded-t-xl w-full">
          <div className="sm:flex text-white sm:flex-row sm:items-center sm:justify-center gap-3 mt-2">
            <button onClick={getRandomGame}
                    className="flex items-center gap-2 rounded-full nm:py-4 nm:px-10 xs:py-2 xs:px-6 xs:mx-auto sm:m-0 border-2 font-bold border-lime-500 hover:bg-lime-500 font-sans">
              <FaRandom size={23}/> Random Game
            </button>
            <button className="flex items-center gap-2 rounded-full nm:py-4 nm:px-12 xs:py-2 xs:px-8 xs:mx-auto sm:m-0 xs:mt-3 font-bold bg-lime-500 font-sans" onClick={scrollToTop}>
