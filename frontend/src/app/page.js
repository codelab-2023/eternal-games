    ...
    <>
      <div className="w-screen text-white min-h-screen overflow-x-hidden">
        ...
        <div className="home-page-sliders h-auto px-3 !z-30 sm:px-5">
          ...
          <h1 className="font-medium text-3xl font-sans text-lime-300 mt-5">Featured Games – Play the Best Eternal Games Online – Brain Games & Mind Puzzles</h1>
          <CarouselMain helper={game} loading={loading} />
          <SpecialCard isHorizontal={true} games={trendingGames} name={'Fun & Challenging Games for Every Skill Level'} loading={loading} />
          <SpecialCard isHorizontal={true} games={featureGames} name={'Eternal Brain Games to Challenge Your Thinking'} loading={loading} />
          <Desktop name={'Free Online Puzzle Games'} helper={game} />
        </div>
        <Footer />
