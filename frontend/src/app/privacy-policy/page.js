          ...
          <Container className="bg-slate-900 rounded-xl p-10 mx-auto my-8">
            ...
            <Box mt={2}>
              ...
              <Typography variant="body1" gutterBottom>
                MAXFLOW BV, a limited liability company under Belgian law with registered office at Ketelmakerij 20, 3010 Kessel-Lo, Belgium, registered under company registration number 0550.758.377
                (RLE
                Leuven), with trade name "<b>CrazyGames</b>" (hereinafter: "<b>CrazyGames</b>", "<b>us</b>", "<b>we</b>", or "<b>our</b>") operates the following sites:
              </Typography>
              <Typography variant="body1" gutterBottom>
                (the "<b>Site</b>"). This privacy policy applies to all of CrazyGames services and products. You should be aware that CrazyGames cannot be held responsible for the privacy policy of
                other
                sites and sources.
              </Typography>
              <Typography variant="body1" gutterBottom>
                CrazyGames will act as the data controller in the framework of this Privacy Policy. By using this Site, you accept this Privacy Policy and you affirm that you are of legal age to agree
                to
                the terms of this Privacy Policy.
              </Typography>
              <Typography variant="body1" gutterBottom>
                Whenever important changes are made to this Privacy Policy, your continued use of the Site will be considered as your consent with the revised Privacy Policy. CrazyGames respects the
                privacy
                of all users of its Site and shall ensure the personal information you provide is treated confidentially.
              </Typography>
              <Typography variant="body1" gutterBottom>
                We are aware of the trust you place in us. We see it as our responsibility to protect your privacy. On this page, we will let you know what information we collect when you use our
                Site,
                why
              ...
              <Typography variant="body1" gutterBottom>
                If you register an account with us you give explicit consent to collect a password, email address, phone number, user agent, and IP address. We do not store this data ourselves but
                work
                with
                ...
                <Link href="https://policies.google.com/technologies/partner-sites" color="primary" underline="always" sx={{ margin: '0 8px' }}> “How Google Uses Information From Sites Or Apps That
                  Use
                  Our
                  Services”.</Link>
              ...
              <Typography variant="body1" gutterBottom>
                IP addresses are logged for a few weeks. Other authentication information is retained until you initiate deletion of the associated user, after which data is removed from live and
                backup
              ...
              <Typography variant="body1" gutterBottom>
                Your personal data will be used to enable us to optimise the services we render and the content we provide on the Site. In certain cases when we are under a legal requirement to
                process
              ...
              <Typography variant="body1" gutterBottom>
                Additionally, we may share information that we collect from you, such as your email (in hashed form), IP address or information about your browser or operating system, with our
                identity
                partners/service providers. These partners return an online identification code that we may store in our first-party cookie for our use in advertising and it may be shared with
                advertising
              ...
              <Typography variant="body1" gutterBottom>
                CrazyGames is not responsible for any personal data collected via any third party software or methods present on the Site and to which said third parties’ general terms and conditions
                may
                apply.
              </Typography>
              <Typography variant="body1" gutterBottom>
              ...
              <Typography variant="body1" gutterBottom>
                Moreover, you have the right to data portability for the personal data you have provided to CrazyGames if any and to the extent that CrazyGames has retained your personal data. If you
                want
              ...
              <Typography variant="body1" gutterBottom>
                You should specifically motivate your request if you want to rectify or erase personal data or restrict the processing thereof. Once these conditions are fulfilled, CrazyGames will
                execute
              ...
              <Typography variant="body1" gutterBottom>
                Cookies are small files that are saved on your computer when you visit web pages. They contain information linked to a web browser and the specific website. They are saved in a
                specific
              ...
              <Typography variant="body1" gutterBottom>
                Cookies are used to increase visitor-friendliness: by identifying visitors with a cookie, they do not always have to enter the same data such as login information or screen settings
                every
              ...
              <Typography variant="body1" gutterBottom>
                <b>First party cookies:</b> these cookies are created by a website to have the web page function better. They regulate the technical part of a site, such as language choice or
                remembering
                the products in the shopping basket in an online store. The visited website creates and places first party cookies.
              </Typography>
              <Typography variant="body1" gutterBottom>
                <b> Third party cookies:</b> these cookies are created and placed on your computer by another (third) party than the website you visit. They remember the behavior of a surfer. Examples
                are
              ...
              <Typography variant="body1" gutterBottom>
                We will only use first party cookies to help improve your user experience on the Site. We would do this by recording specific information about the user such as the language chosen,
                the
              ...
              <Typography variant="body1" gutterBottom>
                Third parties might use information gathered by cookies and/or web beacons for the purpose of online behavioral advertising and/or multisite advertising. The types of information that
                is
                gathered by third party cookies and/or web beacons as well as the purpose(s) for which this information is used, are set out in the privacy policy of said third parties which
                CrazyGames
              ...
              <Typography variant="body1" gutterBottom>
                Google Analytics is a free service by Google to collect statistics of websites and to represent them in detail. The website administrator thus has a clear view on visitor flows,
                traffic
              ...
              <Typography variant="body1" gutterBottom>
                You can do so by adapting your browser settings. Modern browsers allow you to choose to block cookies or to accept only cookies from specific websites. Contact us if you need any help
                in
                doing so.
              </Typography>
              ...
              <Typography variant="body1" gutterBottom>
                At no moment in time will we directly sell or rent out your personal data to third parties. Occasionally we may use an external processor. If we do this, we will always ensure that
                your
                information is handled confidentially and in a safe manner. We also always draw up a contract with these processors. This way the processor will never be allowed to use your data on
                its
                own
