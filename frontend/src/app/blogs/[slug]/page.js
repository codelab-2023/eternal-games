        ...
        <div className="px-2 sm:px-6 py-12 md:py-14">
          <div className="max-w-[7xl] 2xl:container rounded-xl bg-[#121212] mx-auto">
            <div className="pt-4 px-3 sm:px-5">
              <p className="font-bold text-lg xs:text-2xl sm:text-3xl text-center text-[#f7bf16] tracking-wide mb-1 mt-2">{blog?.blogTitle}</p>
              ...
              <div className='border-b border-b-[#f7bf16]/20 mt-4'/>
            </div>
